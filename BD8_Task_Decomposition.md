...
- [X] T-015 Enforce AR-05 in CI: Public API fully typed; mypy clean on kse_memory public surface — FLIPPED 2026-08-30: mypy hard-fails on the 14-module v3 surface (advisory on the v2 remainder until it retires); continue-on-error removed; the soft-fail concession is over
...
- [X] T-025 US2: verify green, mark BD4 TCs [X], journal in BD6 — TC-02 verified clause-by-clause (BD4 verification record); fetch ruling D-102
...
- [X] T-029 US3: verify green, mark BD4 TCs [X], journal in BD6 — TC-03 verified clause-by-clause (BD4 verification record)
...
- [X] T-033 US5: execute story deliverables — BEIR delivered; ESCI slice landed under D-104 (Session 36-CC): committed 6.6MB BEIR-format slice, same make bench, scifact/nfcorpus reproduced bit-identically, ESCI's loss published. Nothing deferred remains
